dst_dir = '/home/aditya/Desktop/My_Images'
...
var.close()
see_image = input("Enter y/Y if you see image else enter n/N")
if(see_image == "Y" or see_image = "y"):
    counter2=int(input("enter admition number to see image : "))

    from PIL import Image
    print(dst_dir)
    dst_dir_new = dst_dir + "/" + str(counter2)
    print(dst_dir_new)
